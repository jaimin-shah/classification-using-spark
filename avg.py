...
with open('diabetes.csv') as csvfile:
    ...
    avg.append(sum(lis0) / len(lis0))

    avg.append(sum(lis1) / len(lis1))

    avg.append(sum(lis2) / len(lis2))

    avg.append(sum(lis3) / len(lis3))

    avg.append(sum(lis4) / len(lis4))

    avg.append(sum(lis5) / len(lis5))

    avg.append(sum(lis6) / len(lis6))

    avg.append(sum(lis7) / len(lis7))
    ...
    for cnt in range(len(lis7)):
        if lis7[cnt] == 0:
            ...
            ch7.append(lis7[cnt])
#print(lis8)
with open('avg.csv', 'w') as csvopfile:
